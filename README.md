...
**Blog-App** is an app that create a fully functional website that will show the list of posts and empower readers to interact with them by adding comments and liking posts.:
...
```sh
  git clone https://github.com/The-Normal-One1/Blog-App.git
```
